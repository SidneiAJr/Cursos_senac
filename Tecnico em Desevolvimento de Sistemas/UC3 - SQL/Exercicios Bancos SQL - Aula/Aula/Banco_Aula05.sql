...
-- Antiga Tabela de locador foi transformada em clientes.
...
('Dalvano Machado', 'Rua das pitangas 114', 'dalvanomachado@gmail.com', '519999999', '12345678900'),
('Kalleo Silva', 'Rua das pitangas 114', 'dalvanomachado3@gmail.com', '519999987', '12345678901'),
('Daniel Silveira Pedro', 'Rua das pitangas 114', 'dalvanomachado4@gmail.com', '519999989', '12345678902'),
('Joao da Silva', 'Rua das pitangas 114', 'dalvanomachado5@gmail.com', '519999900', '12345678903'),
('Joao Silva Junior', 'Rua das pitangas 114', 'dalvanomachado6@gmail.com', '519999912', '12345678904'),
('Olaf Kleins', 'Rua das pitangas 114', 'dalvanomachado7@gmail.com', '519999913', '12345678905');
...
CREATE TABLE `livros` (
  ...
  `lancamento` DATE NOT NULL,  -- Alterado para DATE
...
ADD COLUMN informacao VARCHAR(100);

-- Alterar Tabela clientes 
ALTER TABLE estoque_produtos
ADD COLUMN informacao_produto VARCHAR(100);
...
ALTER TABLE estoque_produtos
CHANGE COLUMN informacao_produto descricao VARCHAR(30);

RENAME TABLE locador TO clientes; -- Conforme solicitado, tabela anterior era locador foi renomeada para clientes

ALTER TABLE estoque_produtos
DROP COLUMN ID ; -- Alterando a tabela estoque_produtos e deletando a ID

DROP TABLE estoque_produtos;

-- Eu tinha criado a tabela locador porem troquei pra clientes.... e esqueci de salvar, deixei ali em cima a antiga tabela e tabela nova.
