...
==================================
           Aula 11
Tipo de JOIN:	
INNER JOIN:	Retorna só as linhas que casam nas duas tabelas
LEFT JOIN:	Traz tudo da esquerda + o que casar na direita
RIGHT JOIN:	Traz tudo da direita + o que casar na esquerda
FULL OUTER JOIN:	Traz tudo de ambos os lados, casando onde possível
==================================
*/
...
SELECT clientes.nome AS cliente, produtos.nome as produto, produtos.preco
FROM compras
JOIN clientes on compras.cliente_id = clientes.id
JOIN produtos ON compras.produto_id = produtos.id
