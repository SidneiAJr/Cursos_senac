...
import TelaVendas from './components/pages/TelaVendas';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        ...
        <Stack.Screen name="API" component={TelaAPi} options={{headerShown: false}} />
        ...
        <Stack.Screen name="vendas" component={TelaVendas} />
        <Stack.Screen name="aa" component={ProfileScreen} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}